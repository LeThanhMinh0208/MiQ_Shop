...
// Static fallback background images per category slug (used when DB category.image.url is empty).
// Slugs are generated by slugify(name, { lower: true, strict: true }) via the Category pre-save hook.
const CATEGORY_BG = {
  'giay-dja-bong':       'https://images.unsplash.com/photo-1511886929837-354d827aae26?w=800&q=80&auto=format&fit=crop',
  'ao-djau-clb':         'https://images.unsplash.com/photo-1671016233693-53162078ca1c?w=800&q=80&auto=format&fit=crop',
  'trang-phuc-the-thao': 'https://images.unsplash.com/photo-1629977007371-0ba395424741?w=800&q=80&auto=format&fit=crop',
  'phu-kien':            'https://images.unsplash.com/photo-1521731978332-9e9e714bdd20?w=800&q=80&auto=format&fit=crop',
};
...
const BentoCard = ({ category, config, index }) => {
  ...
  const bgUrl = category.image?.url
    ? optimizeImg(category.image.url)
    : CATEGORY_BG[category.slug] ?? null;

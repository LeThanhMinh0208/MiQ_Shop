...
const FlashSaleManagement   = lazy(() => import('./pages/admin/FlashSaleManagement.jsx'));
const NewArrivalManagement  = lazy(() => import('./pages/admin/NewArrivalManagement.jsx'));
      ...
      {isAdminRoute ? (
        <Routes>
          ...
          >
            ...
            <Route path="flash-sale"   element={<Suspense fallback={<AdminLoadingFallback />}><FlashSaleManagement /></Suspense>} />
            <Route path="new-arrivals" element={<Suspense fallback={<AdminLoadingFallback />}><NewArrivalManagement /></Suspense>} />
          </Route>
        </Routes>
      ) : (
        <PublicLayout>

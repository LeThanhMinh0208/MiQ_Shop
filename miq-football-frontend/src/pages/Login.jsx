...
const Login = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12">
      ...
      >
        <h1 className="font-display text-3xl font-bold mb-2 text-center">ĐĂNG NHẬP</h1>
        <p className="text-ink-muted text-center mb-6">Chào mừng quay trở lại MiQ!</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? <Loader className="w-5 h-5 animate-spin" /> : 'ĐĂNG NHẬP'}
          </button>
        </form>

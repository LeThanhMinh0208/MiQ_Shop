  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'neon-xs':    '0 0 8px rgba(16,185,129,0.25)',
        ...
        'button-primary': '0 4px 14px rgba(16,185,129,0.4)',
        'button-primary-hover': '0 6px 20px rgba(16,185,129,0.55)',
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'gradient-primary-soft': 'linear-gradient(135deg, #ECFDF5 0%, #D1FAE5 100%)',
